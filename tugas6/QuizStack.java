public class QuizStack {
	...
	public static void main(String[] args) {
		...
		Mhs mhs1 = new Mhs(1, "121", "Andi", "SI");
		Mhs mhs2 = new Mhs(2, "122", "Jeni", "SI");
		Mhs mhs3 = new Mhs(3, "123", "Ameera", "SI");
		Mhs mhs4 = new Mhs(4, "124", "Rafika", "SI");
		Mhs mhs5 = new Mhs(5, "125", "Berliana", "SI");
